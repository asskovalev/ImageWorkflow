...
namespace Imglib
{
	...
	{  // Simplex noise in 2D, 3D and 4D
		...
		private const double F2 = 0.5 * (1.7320508075688772935274463415059 - 1.0);
		private const double G2 = (3.0 - 1.7320508075688772935274463415059) / 6.0;
		/// <summary>
		/// 2D simplex noise
		/// </summary>
		...
		private const double F4 = (2.2360679774997896964091736687313 - 1.0) / 4.0;
		private const double G4 = (5.0 - 2.2360679774997896964091736687313) / 20.0;
